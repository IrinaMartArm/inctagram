...
export const LargeWithoutPhoto: Story = {
  args: {
    alt: "Some alt",
  },
};
...
export const MediumWithoutPhoto: Story = {
  args: {
    alt: "Some alt",
    size: "md",
  },
...
export const SmallWithoutPhoto: Story = {
  args: {
    alt: "Some alt",
    size: "sm",
  },
...
export const LargeIsEditProfile: Story = {
  args: {
    alt: "Some alt",
    isEditProfile: true,
  },
...
export const LargeIsEditProfileWithPhoto: Story = {
  args: {
    alt: "Some alt",
    isEditProfile: true,
    src: boy.src,
...
export const MediumIsEditProfile: Story = {
  args: {
    alt: "Some alt",
    isEditProfile: true,
    size: "md",
...
export const SmallIsEditProfile: Story = {
  args: {
    alt: "Some alt",
    isEditProfile: true,
    size: "sm",
