export default {
  ...
  2: {
    options: [
      ...
      'Website - a combination of graphic and informational materials, as well as computer software and databases, ensuring their availability on the Internet at the network address https://inctagram.org.',
      'Information system of personal data is a combination of personal data contained in databases and information technologies and technical means ensuring their processing.',
      'Anonymization of personal data is the actions as a result of which it is impossible to determine without using additional information the belonging of personal data to a specific User or other subject of personal data.',
      ...
      'User - any visitor to the website https://inctagram.org.',
      'The provision of personal data is actions aimed at disclosing personal data to a specific person or a specific group of persons.',
      'The dissemination of personal data is any actions aimed at disclosing personal data to an indefinite group of persons (transmission of personal data) or at acquainting an unlimited group of persons with personal data, including the disclosure of personal data in the media, placement in information and telecommunication networks, or providing access to personal data in any other way.',
    ...
    sections: [
      ...
      },
      {
        content: [
          ...
          'take legal, organizational and technical measures to protect personal data from unlawful or accidental access to them, destruction, alteration, blocking, copying, provision, distribution of personal data, as well as from other illegal actions in relation to personal data;',
    ...
    sections: [
      {
        content: [
          ...
          'to put forward a condition of preliminary consent when processing personal data for the purposes of promoting goods, works and services in the market;',
  ...
  5: {
    options: [
      ...
      'The content and volume of processed personal data correspond to the declared purposes of processing. The redundancy of processed personal data in relation to the declared purposes of their processing is not allowed.',
  ...
  6: {
    sections: [
      ...
      {
        content: ['contracts concluded between the operator and the subject of personal data'],
        title: 'Legal basis',
      },
      {
        content: [
  ...
  7: {
    options: [
      ...
      'Personal data processing is necessary for the exercise of the rights and legitimate interests of the operator or third parties or for achieving socially significant goals, provided that this does not violate the rights and freedoms of the personal data subject.',
  ...
  8: {
    options: [
      ...
      'In case of detection of inaccuracies in personal data, the User can update them independently, by sending a notification to the Operator\'s email address inctagram@gmail.com marked "Updating personal data".',
      'The term of personal data processing is determined by achieving the goals for which personal data were collected, if another term is not provided for by the contract or current legislation. The User can at any time revoke his consent to the processing of personal data, by sending a notification to the Operator via email to the Operator\'s email address inctagram@gmail.com marked "Withdrawal of consent to the processing of personal data".',
  ...
  12: {
    options: [
      ...
      'The current version of the Policy is freely available on the Internet at https://inctagram.org/auth/policy.',
    ],
