...
const PrivacyPolicy = () => {
  ...
  const general = [
    ...
    "1.2. Настоящая политика Оператора в отношении обработки персональных " +
      ...
      "Оператор может получить о посетителях веб-сайта https://inctagram.org.",
  ];
  ...
  const basicConcepts = [
    ...
    "2.3. Веб-сайт — совокупность графических и информационных материалов, " +
      ...
      "сети интернет по сетевому адресу https://inctagram.org.",
    ...
    "2.10. Пользователь — любой посетитель веб-сайта https://inctagram.org.",
  ...
  const orderOfProcessing = [
    ...
    "8.3. В случае выявления неточностей в персональных данных, Пользователь " +
      ...
      "уведомление на адрес электронной почты Оператора inctagram@gmail.com " +
    ...
    "8.4. Срок обработки персональных данных определяется достижением целей," +
      ...
      "электронной почты на электронный адрес Оператора inctagram@gmail.com " +
  ...
  const finalProvisions = [
    "12.1. Пользователь может получить любые разъяснения по интересующим" +
      ...
      "Оператору с помощью электронной почты inctagram@gmail.com.",
    ...
    "12.3. Актуальная версия Политики в свободном доступе расположена " +
      "в сети Интернет по адресу https://inctagram.org.",
  ];
  ...
  return (
    <div className={s.wrapper}>
      ...
      />
      <InformationTitle text={"1. Общие положения"} />
      <InformationText
        text={
      ...
      />
      <InformationTextBlock options={orderOfProcessing} />
      ...
      <InformationTitle
        text={"11. Конфиденциальность персональных данных персональных данных"}
      />
      <InformationText
        text={
